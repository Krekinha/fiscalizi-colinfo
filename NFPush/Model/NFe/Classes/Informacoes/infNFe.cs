...
using NFPush.Model.NFe.Classes.Informacoes.Cana;
using NFPush.Model.NFe.Classes.Informacoes.Cobranca;
using NFPush.Model.NFe.Classes.Informacoes.Destinatario;
using NFPush.Model.NFe.Classes.Informacoes.Detalhe;
using NFPush.Model.NFe.Classes.Informacoes.Emitente;
using NFPush.Model.NFe.Classes.Informacoes.Identificacao;
using NFPush.Model.NFe.Classes.Informacoes.Observacoes;
using NFPush.Model.NFe.Classes.Informacoes.Pagamento;
using NFPush.Model.NFe.Classes.Informacoes.Total;
using NFPush.Model.NFe.Classes.Informacoes.Transporte;
