...
namespace FiscaliZi.MDFast.Model
{
    public class DataService : IDataService
    {
        ...
        public void GerarDadosVeiculos()
        {
            ...
            {
                new Veiculo { Placa = "HXO2461", Tara = 19000, CapKG = 39000, TPRod = "02", TPCar = "00", UF = "MG", Motorista = new Motorista() { Nome = "EDUARDO DOS REIS BATISTA", CPF = "05355520685" } },
                ...
                new Veiculo { Placa = "MET3489", Tara = 19000, CapKG = 39800, TPRod = "06", TPCar = "00", UF = "MG", Motorista = new Motorista() { Nome = "MARCELO CAPOVILLA", CPF = "38711273615" } },
                ...
                new Veiculo { Placa = "MEB4051", Tara = 19000, CapKG = 39000, TPRod = "02", TPCar = "00", UF = "MG", Motorista = new Motorista() { Nome = "VENI PEREIRA DA COSTA", CPF = "05739590647" } },
